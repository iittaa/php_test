          ...
          <div class="col-md-6">
            <form method="POST" action="input.php">
              ...
              <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="gender1" name="gender" value="1" <?php if(!empty($_POST["gender"]) && $_POST["gender"] === "1"){echo "checked" ;} ?> required>
                <label class="form-check-label" for="gender1">男性</label>
              </div>
              <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="gender2" name="gender" value="2" <?php if(!empty($_POST["gender"]) && $_POST["gender"] === "2"){echo "checked" ;} ?> required>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="contact" row="3" id="contact"></textarea>
              </div>
    ...
    <?php if($pageFlag === 1):?>
      <?php if($_POST["csrf"] === $_SESSION["csrfToken"]) : ?>
        <form method="POST" action="input.php">
          ...
          <br>
          性別
          <?php if($_POST["gender"] === "1"){echo "男性";} ?>
          <?php if($_POST["gender"] === "2"){echo "女性";} ?>
          <br>
          年齢
